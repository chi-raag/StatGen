...
Compute $w$ and $1-w$. Then, using the example counts $(n_{AB}, n_{Ab}, n_{aB}, n_{ab})=(18, 5, 4, 17)$ (so $N=44$, $n_{\mathrm{R}}=9$, $n_{\mathrm{NR}}=35$), evaluate and **compare**
$\mathrm{LOD}(\hat\theta; w=\tfrac12)$ versus $\mathrm{LOD}(\hat\theta; w)$ at $\hat\theta = n_{\mathrm{R}}/N$.  
